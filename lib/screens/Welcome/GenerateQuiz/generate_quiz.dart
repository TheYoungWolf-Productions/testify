      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          padding: EdgeInsets.only(left: (MediaQuery.of(context).size.width) *(17/428), right: (MediaQuery.of(context).size.width) *(17/428)),
            ...
            SizedBox(height: (MediaQuery.of(context).size.height) *(17.9/926),),
            Container(
              height: (MediaQuery.of(context).size.height) *(167.52/926),
              color: Colors.red,
            ),
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      onPressed: () async {
                        final result = await Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => QuestionTypes()),
                        );
                      },
                      child: Center(
                        child: Text("Next",
