...
import 'package:testify/screens/Welcome/PreviousQuiz/TestResults/testResults.dart';
...
class _TestDetailsState extends State<TestDetails> {
  ...
  bool _isResumeQuizLoading = true;
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            width: (MediaQuery.of(context).size.width) * (385 / 428),
                            child: _isResumeQuizLoading ? Center(child: CircularProgressIndicator(color: Color(0xff7F1AF1),)) : Row(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    final result = Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => TestAnalysis(quizId: widget.quizId)),
                                    );
                                  },
                                  child: Column(
                                    children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    final result = Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => TestResults(quizId: widget.quizId, fromWhere: "PrevQuiz",)),
                                    );
                                  },
                                  child: Column(
                                    children: [
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    if(_resumeQuizSuccessful.data.previousQuizzes[0].quizMeta.quizStatus == "suspended") {
                                      SharedPreferences prefs = await SharedPreferences.getInstance();
                                    ...
                                    else if(_resumeQuizSuccessful.data.previousQuizzes[0].quizMeta.quizStatus == "completed") {
                                      print("Reviewed");
                                      SharedPreferences prefs = await SharedPreferences.getInstance();
                                      prefs.setInt("quizId", widget.quizId);
                                      List<int> _quizQuestions = [];
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      ,Text(_resumeQuizSuccessful.data.previousQuizzes[0].quizMeta.quizStatus == "suspended" ? 'Resume' : 'Review',style: TextStyle(
                                        color: Color(0xff7F1AF1),
                                        fontFamily: 'Brandon-med',
                                        fontSize: (MediaQuery.of(context).size.height) * (15 / 926),
                                      ),)
